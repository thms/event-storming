    ...
    get:
      ...
      parameters:
        - name: id
          in: path
          required: true
          description: ID of the read model to retrieve
          schema:
            type: string
      responses:
        '200':
    ...
    put:
      ...
      parameters:
        - name: id
          in: path
          required: true
          description: ID of the read model to update
          schema:
            type: string
      requestBody:
        required: true
    ...
    delete:
      ...
      parameters:
        - name: id
          in: path
          required: true
          description: ID of the read model to delete
          schema:
            type: string
      responses:
        '204':
...
Generated at: 2024-09-13 12:05:40